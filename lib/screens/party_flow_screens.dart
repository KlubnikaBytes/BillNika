  ...
  Future<void> _saveQuickParty() async {
    ...
    try {
      ...
      if (res.statusCode == 200 || res.statusCode == 201) {
        ...
        String errorMsg = data['errors'].values.first[0];
...
class _CreateNewPartyScreenState extends State<CreateNewPartyScreen>
  ...
  bool isValidGST(String gst) {
    ...
    if (!regex.hasMatch(gst)) return false;
                          ...
                          ListView(
                            ...
                            children: [
                              ...
                              TextFormField(
                                ...
                                onChanged: (_) => _formKey.currentState?.validate(), // 🔥 ADD THIS
                                ...
                                validator: (value) {
                                  ...
                                  final gst = value.trim().toUpperCase(); // ✅ FIX

                                  if (gst.length != 15) return "GST must be 15 characters";
                              ...
                              TextFormField(
                                ...
                                validator: (value) {
                                  ...
                                  final pan = value.trim().toUpperCase(); // ✅ FIX
